...
import com.secure.authium.models.RolePermission;
import com.secure.authium.repositories.PermissionRepository;
import com.secure.authium.repositories.RolePermissionRepository;
...
public class PermissionInitializer {
    ...
    public CommandLineRunner initializePermissions(
        ...
        return args -> {
            ...
            // Save all default permissions if not already present
